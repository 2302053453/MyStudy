...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	b2RopeJointDef ropeJpointDef1;
	b2RopeJointDef ropeJpointDef2;
	b2RopeJointDef ropeJpointDef3;
	b2RopeJointDef ropeJpointDef4;
	...
	ropeJpointDef1.bodyA = body1;
	ropeJpointDef1.bodyB = body2;
	ropeJpointDef1.localAnchorA = b2Vec2(1, 0);
	ropeJpointDef1.localAnchorB = b2Vec2(-1,0);
	ropeJpointDef1.maxLength = 1;
	ropeJpointDef1.collideConnected = false;
	_world->CreateJoint(&ropeJpointDef1);

	ropeJpointDef2.bodyA = body2;
	ropeJpointDef2.bodyB = body3;
	ropeJpointDef2.localAnchorA = b2Vec2(1, 0);
	ropeJpointDef2.localAnchorB = b2Vec2(-1, 0);
	ropeJpointDef2.maxLength = 1;
	ropeJpointDef2.collideConnected = false;
	_world->CreateJoint(&ropeJpointDef2);

	ropeJpointDef3.bodyA = body3;
	ropeJpointDef3.bodyB = body4;
	ropeJpointDef3.localAnchorA = b2Vec2(1, 0);
	ropeJpointDef3.localAnchorB = b2Vec2(-1, 0);
	ropeJpointDef3.maxLength = 1;
	ropeJpointDef3.collideConnected = false;
	_world->CreateJoint(&ropeJpointDef3);

	ropeJpointDef4.bodyA = body5;
	ropeJpointDef4.bodyB = body4;
	ropeJpointDef4.localAnchorA = b2Vec2(-1, 0);
	ropeJpointDef4.localAnchorB = b2Vec2(1, 0);
	ropeJpointDef4.maxLength = 1;
	ropeJpointDef4.collideConnected = false;
	_world->CreateJoint(&ropeJpointDef4);
