...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	// 바디를 생성해서 필드에 추가한다.
	auto body0 = this->AddNewSprite(Vec2(240, 160), Size(160, 60), b2_staticBody, NULL, 0);
	auto body1 = this->AddNewSprite(Vec2(240-22, 160), Size(40, 40), b2_dynamicBody, NULL, 1);
	auto body2 = this->AddNewSprite(Vec2(240+22, 160), Size(40, 40), b2_dynamicBody, NULL, 1);

	revJointDef1.Initialize(body0, body1, body1->GetPosition());
	revJointDef2.Initialize(body0, body2, body2->GetPosition());
	
	revJointDef1.enableMotor = true;
	revJointDef1.motorSpeed = 1;
	revJointDef1.maxMotorTorque = 10;

	// revJoint1을 생성하기 전에 위 모터의 속성들을 정의해야 한다.
	revJoint1 = (b2RevoluteJoint*)_world->CreateJoint(&revJointDef1);
	revJoint2 = (b2RevoluteJoint*)_world->CreateJoint(&revJointDef2);

	gearJointDef.bodyA = body1;
	gearJointDef.bodyB = body2;
	gearJointDef.joint1 = (b2Joint*)revJoint1;
	gearJointDef.joint2 = (b2Joint*)revJoint2;
