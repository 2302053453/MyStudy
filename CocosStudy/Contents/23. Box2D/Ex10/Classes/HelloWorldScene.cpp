...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	auto body1 = this->AddNewSprite(Vec2(240, 280), Size(40, 40), b2_dynamicBody, "test", 0);
	auto body2 = this->AddNewSprite(Vec2(340, 280), Size(40, 40), b2_dynamicBody, "test", 0);

	// RopeJointDef 초기화
	ropeJointDef.bodyA = body1;
	ropeJointDef.bodyB = body2;
	ropeJointDef.localAnchorA = b2Vec2(1, 0);
	ropeJointDef.localAnchorB = b2Vec2(-1, 0); //-1 -1
