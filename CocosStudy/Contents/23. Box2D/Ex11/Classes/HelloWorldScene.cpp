...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	b2FrictionJointDef friJointDef;

	auto body1 = this->AddNewSprite(Vec2(240, 260), Size(40, 40), b2_dynamicBody, "test", 0);
	auto body2 = this->AddNewSprite(Vec2(340, 260), Size(40, 40), b2_dynamicBody, "test", 0);

	friJointDef.Initialize(body1, body2, body1->GetPosition());
	friJointDef.maxForce = 20;
	friJointDef.maxTorque = 10;

	_world->CreateJoint(&friJointDef);
